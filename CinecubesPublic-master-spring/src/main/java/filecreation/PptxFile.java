...
public class PptxFile extends FileMgr {
	...
	protected void createIntroSlide(Slide episode, int count) {
		...
		Map<String,String> introSlideData = new HashMap<String,String>();
		...
		introSlideData.put("Title",episode.getTitle());
		introSlideData.put("Subtitle",episode.getSubTitle());
		introSlideData.put("Notes",episode.getNotes());
	}
